...
export type TRequesTCommonComponentProps<T = any> = T & {
  url: string
  options?: typeof AXIOS_INSTANCE
}

export type TRequestData<T = any> = T & {
  key?: string
  avatar?: string
  collectionId?: string
...
export type THandleGetProps<T = any> = TRequesTCommonComponentProps & T

export type THandlePostProps<T = any> = THandleGetProps &
  T & {
    data?: TRequestData | object
  }

export type THandlePutProps<T = any> = THandlePostProps & T

export type THandleDeleteProps<T = any> = THandleGetProps & T

export type TRequestProps<T = any> = THandlePostProps &
  T & {
    method:
      | 'GET'
      | 'get'
